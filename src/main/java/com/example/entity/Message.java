...
public class Message {
    ...
    /**
     * needs association with message entity aand Spring data cannot automatically 
     * resolvee the issue findByAccountId or findByAccount_AccountId, theres no association
     */
    /**
